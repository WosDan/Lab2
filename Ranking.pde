class Ranking {
  ...
  public String[] ranking5 = new String[10];
  public String src;
  ...
  Ranking(String src) {
    ...
    if (condition) {
      ...
      rankingCsv.addColumn("5");

      agregarOActualizar("Salma", 100.0, 999, 999, 999, 999);
      agregarOActualizar("Javier", 100.0, 999, 999, 999, 999);
      agregarOActualizar("Catalina", 100.0, 999, 999, 999, 999);
      agregarOActualizar("Daniel", 100.0, 999, 999, 999, 999);
    }

    saveTable(rankingCsv, src);
  }

  public void agregarOActualizar(String nombre, float j1, int j2, int j3, int j4, int j5) {
    ...
    if (fila == null) {
      ...
      if (j4 > fila.getInt("5")) fila.setInt("5", j5);
    }
  ...
  public void displayTops(float startX, float startY, float colWidth, float rowHeight, float colSpacing, float rowSpacing) {
    ...
    textSize(width*0.02);
    actualizarRanking();
    String[][] tops = {ranking, ranking2, ranking3, ranking4, ranking5};
    String[] titulos = {"Top Juego 1", "Top Juego 2", "Top Juego 3", "Top Juego 4", "Top Juego 5"};
